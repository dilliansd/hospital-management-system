...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Hospital of Coventry</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Hospital of Coventry </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #blue, #violet);
}
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Welcome in our Hospital portal! &nbsp<?php echo $username ?> 
   </h3>
    <div class="row">
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Appointment</h2>
